...
Using the `@magento-research/pwa-nextjs-routes` PWA Studio extension, you can organize custom pages in your PWA similarly to the popular [NextJS](https://nextjs.org/docs/routing/dynamic-routes) framework. Reproduced below is the NextJS routing documentation; the only difference is that you fetch routing parameters using the `useParams()` hook from React Router.
